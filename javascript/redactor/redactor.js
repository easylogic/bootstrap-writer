...
(function($){
	...
	Redactor.prototype = {
		...
		build: function()
		{
			...
			// frame
			this.$frame = $('<iframe id="redactor_box_frame" frameborder="0" scrolling="auto" style="height: ' + this.height + ';" class="redactor_frame">&nbsp;</iframe>');
		...
		{
			this.$editor.css({ 'min-height': this.$el.height() + 'px', 'height': this.$el.height() + 'px' });
