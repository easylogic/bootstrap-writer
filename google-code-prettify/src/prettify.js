...
(function() {
    ...
    function applyDecorator(job) {
        ...
        try {
            ...
            var sourceAndSpans = extractSourceSpans(job.sourceNode, job.pre); /** Plain text. @type {string} */
                ...
                if (prettyPrintRe.test(className)) {
                    ...
                    if (!nested) {
                        ...
                        if (preformattedTagNameRe.test(cs.tagName)) {
                            ...
                            var whitespace = (
                            currentStyle ? currentStyle['whiteSpace'] : (document.defaultView && document.defaultView.getComputedStyle) ? document.defaultView.getComputedStyle(cs, null).getPropertyValue('white-space') : 0);
